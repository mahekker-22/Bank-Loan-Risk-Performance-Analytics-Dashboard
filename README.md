...
Below is a visual overview of the interactive multi-page business intelligence dashboard developed for this project. 

*(Tip: Take screenshots of your Power BI dashboard tabs, save them in a folder named `screenshots`, and match the names below to display your work immediately to recruiters!)*

### Page 1: Executive KPI Dashboard
Tracks high-level loan metrics, good vs. bad loan distributions, and month-over-month data trends.
![Executive Dashboard Overview](screenshots/dashboard_overview.png)

### Page 2: Regional & Demographic Insights
Maps application concentrations across different states and breaks down lending trends by borrower employment history and income verification.
<img width="1913" height="944" alt="image" src="https://github.com/user-attachments/assets/11b408f1-a00a-4052-9b2d-c07dd440c19a" />
